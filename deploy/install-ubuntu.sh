...
if [ ! -f /etc/nginx/sites-available/fpevalua ]; then
  ...
  echo "Configuración Nginx local instalada en 127.0.0.1:8080 para Cloudflare Tunnel."
else
  echo "Nginx ya estaba configurado. Revisa que FPEvalúa escuche solo en 127.0.0.1:8080 si usarás Cloudflare Tunnel."
fi
...
echo "Para Cloudflare Tunnel publica el servicio interno http://127.0.0.1:8080."
